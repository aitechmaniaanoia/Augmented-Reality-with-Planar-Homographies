...
for i = 0:36
    ...
    %% Match features
    indexPairs = matchFeatures(desc1, desc2, 'MatchThreshold', 10,'MaxRatio', 0.68); % BRIEF
    indexPairs1 = matchFeatures(features_1, features_2, 'MatchThreshold', 10,'MaxRatio', 0.68); % SURF
    %% Update histogram
